...
| 주차              | 카테고리 | 내용            |
| --------------- | ---- | ------------- |
| 1주차(2023.07.18) | 네트워크 | 모두의 네트워크 1~2장 |
| 2주차(2023.07.25) | 네트워크 | 모두의 네트워크 3~4장 |
...
| 주차              | 발표자     | 발표주제                 |
| --------------- | ------- | -------------------- |
| 1주차(2023.07.25) | **엄한결** | Domain Driven Design |
| 2주차(2023.07.25) | **이명우** | 내용입력바람               |
| 3주차(2023.08.01) | **하재우** | 내용입력바람               |
| 4주차(2023.08.08) | **정예륜** | 내용입력바람               |
